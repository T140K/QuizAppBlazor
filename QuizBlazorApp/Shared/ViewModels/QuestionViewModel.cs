...
namespace QuizBlazorApp.Shared.ViewModels
{
    public class QuestionViewModel
    {
        ...
        //do this in the QuizResponse part so that the timings are handeld by the viewmodel with time
        //starting on getting a question and time ending on answering or posting a answer
    }
}
